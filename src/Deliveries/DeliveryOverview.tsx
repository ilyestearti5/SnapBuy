      ...
      <div className="flex max-md:flex-col md:items-center gap-2">
        <AnimatePresence mode="wait">
          ...
          {!salesData && (
            ...
            >
              <CardWait className="rounded-2xl w-full h-[250px]" />
            </motion.div>
          )}
        </AnimatePresence>
        <AnimatePresence mode="wait">
          ...
          {todayOrders !== null && (
            <FadeIn delay={0.4} className="md:w-1/3">
              <Card
                onClick={() => {
                ...
                className="flex flex-col justify-evenly active:bg-[--biqpod-gray-opacity] p-3 w-full md:w-1/3 h-[150px] cursor-pointer"
              >
