export const populareDeliveryCompanies: Record<
  string,
  {
    name: string;
    list: any[];
...
> = {
  ...
  ma: {
    name: "Morocco",
    dropPhoto:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2c/Flag_of_Morocco.svg/langfr-250px-Flag_of_Morocco.svg.png",
    list: [
      {
        name: "Aramex",
        description:
  ...
  tn: {
    name: "Tunisia",
    dropPhoto:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/c/ce/Flag_of_Tunisia.svg/langfr-250px-Flag_of_Tunisia.svg.png",
    list: [
      {
        name: "Aramex",
        description:
  ...
  ly: {
    dropPhoto:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/0/05/Flag_of_Libya.svg/langfr-250px-Flag_of_Libya.svg.png",
    name: "Libya",
    list: [
      {
        name: "Aramex",
  ...
  es: {
    dropPhoto:
      "https://upload.wikimedia.org/wikipedia/en/thumb/9/9a/Flag_of_Spain.svg/250px-Flag_of_Spain.svg.png",
    name: "Spain",
    list: [
      {
        name: "Correos",
