/**
 * AI Configuration for Biqpod.Snapbuy
 *
 * This file contains configuration options for different AI backends
 * and providers that can be used with the Biqpod.Snapbuy AI assistant.
 */
...
export const SHOPPING_PROMPTS = {
  systemPrompt: `You are a helpful AI shopping assistant for Biqpod.Snapbuy, an e-commerce platform. Your role is to:
